...
int main()
{
    ...
    len = sizeof(buffsize);
    MD5_Init(&context);
    MD5_Update(&context,(unsigned char *)&buffsize[0], 1024);
    MD5_Update(&context,(unsigned char *)&buffsize[1024*1], 1024);
    MD5_Update(&context,(unsigned char *)&buffsize[1024*2], 1024);
    MD5_Update(&context,(unsigned char *)&buffsize[1024*3], 1024);
    MD5_Final(&context,buff);
    printf("MD5_1024 \n");
    for(j=0;j<16;j++)
    {
