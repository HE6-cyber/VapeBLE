...
#define TSMessageViewMinimumPadding 4.0
...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        else
        {
            ...
            self.backgroundBlurView.blurTintColor = [UIColor colorWithHexString:[current valueForKey:@"backgroundColor"]];
//            NSLog(@"ddd:%@", current[@"backgroundColor"]);
            [self addSubview:self.backgroundBlurView];
        }
        UIColor *fontColor = [UIColor colorWithHexString:[current valueForKey:@"textColor"] andAlpha:1.0];
        ...
        [self.titleLabel setShadowColor:[UIColor colorWithHexString:[current valueForKey:@"shadowColor"] andAlpha:1.0]];
        ...
        if ([subtitle length])
        {
            ...
            UIColor *contentTextColor = [UIColor colorWithHexString:[current valueForKey:@"contentTextColor"] andAlpha:1.0];
            if (!contentTextColor)
            {
        ...
        if ([buttonTitle length])
        {
            ...
            UIColor *buttonTitleShadowColor = [UIColor colorWithHexString:[current valueForKey:@"buttonTitleShadowColor"] andAlpha:1.0];
            ...
            UIColor *buttonTitleTextColor = [UIColor colorWithHexString:[current valueForKey:@"buttonTitleTextColor"] andAlpha:1.0];
    ...
    //为视图添加边框 Added by Zhoucy 2016-10-9
//    self.layer.cornerRadius = 5.f;//self.frame.size.height*0.25;
