...
@interface DownloadSmokingDataResponseRoot : GPBRootObject
@end

#pragma mark - DownloadSmokingDataResponseMessage

typedef GPB_ENUM(DownloadSmokingDataResponseMessage_FieldNumber) {
  DownloadSmokingDataResponseMessage_FieldNumber_ErrorMsg = 1,
  DownloadSmokingDataResponseMessage_FieldNumber_SmokingDatasArray = 2,
};

@interface DownloadSmokingDataResponseMessage : GPBMessage
